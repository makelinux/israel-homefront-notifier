...
class TestSeenAlerts(unittest.TestCase):
    def test_load_returns_empty_set_if_file_missing(self):
        from israel_homefront_notifier import load_seen_alerts

        result = load_seen_alerts("/nonexistent/seen.json")
        self.assertEqual(result, set())

    def test_save_and_load_roundtrip(self):
        from israel_homefront_notifier import load_seen_alerts, save_seen_alerts
    ...
    def test_save_creates_parent_directory(self):
        from israel_homefront_notifier import save_seen_alerts
